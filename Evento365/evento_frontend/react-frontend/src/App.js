...
import BirthdayCategory from './StoreComponents/BirthdayCategory';
//import FooterComponent from './StoreComponents/FooterComponent';
          ...
          <div>
            <Switch>
              ...
              <Route path = "/payments" component = {ListPayDetailComponent}></Route>
                ...
                <Route path = "/birthday" component = {BirthdayCategory}></Route>

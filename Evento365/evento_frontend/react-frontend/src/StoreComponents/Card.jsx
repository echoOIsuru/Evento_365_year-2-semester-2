...
class Card extends Component {
  ...
  render() {
    return (
      ...
      <div className="col s10 m4 test" style={{ boxShadow: "shadow: -1px 8px 15px 0px rgba(0, 0, 0, 0.44"}}>

    
        <center>
        <div className="card medium" style={{width:'300px'}}>
          <div className="card-image">
           <img src={this.props.img_url} alt="" style={{height:"200px"}}/>

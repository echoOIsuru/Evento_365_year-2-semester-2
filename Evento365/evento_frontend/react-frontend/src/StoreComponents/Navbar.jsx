    ...
    return (
      <React.Fragment>
        ...
        <nav id="scroll" className="scrollspy" /*classname="sidenav-overlay"*/>   
          <ul id="slide-out" className="sidenav sidenav-close" style={{ width: "50%" }}>
            ...
            <li>
              <a href="#">
                ...
                <span style={{fobtSize:"10px"}} className="teal-text">Cart</span>
              </a>
            </li>
            <li>
              <div className="row">
          ...
          <div style={{ width:"105%",margin:"-80px",backgroundColor:"#212529" }} className="nav-wrapper">
            <Link to="/">
...
<li>
             <h5 style={{marginLeft:"100px"}}>EVENTO 365 </h5>
            ...
            <li>
              ...
              <li>
              <a href onClick={this.link1.bind(this)}>Birthday</a>

    ...
    return (
      ...
      <div className="col s25 m5 test" style={{ background: "#fff0f3", margin: "10px" }}>
          ...
          <div class="py-5 text-center">
            ...
            <h4 className="header" style={this.stylehead()}>Checkout form</h4>
            <br></br>
          </div>
...
<div style={{marginLeft:"400px",width:"1000px",align:"center"}}>
...
<div class="col-md-20 order-md-10 mb-10">
  <h5 style={{marginTop:"30px"}} class="d-flex justify-content-between align-items-center mb-3">
...
<td style={{width:"1000px",align:"right",fontSize:"50px"}} class="my-0">{this.state.temp.map(
          items =>
            <div style={{fontSize:"20px"}} value={this.state.total_items} 
...
<td style={{width:"500px",textAlign:"right"}} >{this.state.temp.map(
          items =>
            <div><span class="text-muted" style={{fontSize:"20px"}} >{items.price}</span><br></br><br></br></div>
...
<tr style={{border:"3px dashed pink"}} >
  ...
  <td style={{width:"500px",textAlign:"left"}}><span style={{fontSize:"20px"}}>Total</span></td>
 
<td value={this.state.total} 

 onChange={this.changeTotalHandler} style={{width:"150px",textAlign:"right"}}><span style={{fontSize:"20px"}}>{this.state.total}  
                    </span> </td>
  </tr>
</div>
    </li>

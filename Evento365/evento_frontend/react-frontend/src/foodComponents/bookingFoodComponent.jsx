...
class bookingFoodComponent extends Component {
    ...
    confirmFood =(e) => {
        ...
        let bookFood = { cost: this.state.cost, booking_id: this.state.bookingid , food_package_id: this.state.foodcategoryid, food_package_name: this.state.foodcategory , count:this.state.count , total:(this.state.count*this.state.cost )};

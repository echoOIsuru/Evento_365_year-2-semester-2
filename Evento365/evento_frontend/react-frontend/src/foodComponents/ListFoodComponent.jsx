                    ...
                    <table style={{ backgroundColor: "rgba(255, 237, 213, 0.8)"}} className = "table table-striped table-bordered">
                        <thead>
                            <tr className="customerTR">
                                ...
                                <th style={{textAlign:"center",fontSize:"20px", width:"10%"}}>Food package Types </th>
                                <th style={{textAlign:"center",fontSize:"20px", width:"18%"}}>Description</th>
                                <th style={{textAlign:"center",fontSize:"20px", width:"8%"}}>Cost</th>
                        ...
                        <tbody className="customerTbody">
                            {
                                this.state.food.map(
                                    food =>
                                   <tr key ={food.foodid}>
                                       <td style={{fontSize:"17px"}}> {food.foodcategoryid} </td>

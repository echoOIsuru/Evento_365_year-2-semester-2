...
class UpdatePromoCodeComponent extends Component {
    ...
    updatePromo = (e) => {
        ...
        PromoService.getPromocodes().then((res) => {
            ...
            //this.state.retrivedcode is the retrieved promocode that is currently in updating
            //this.state.code is the code that entered by the user in text field in order to update

            for (var i = 0; i < len; i++) {
                console.log(Promocheck[i].code.toLowerCase(), "promos from database");
                console.log(this.state.retrivedcode.toLowerCase(), "promos from database");
                if (Promocheck[i].code.toUpperCase() == this.state.code.toUpperCase() && Promocheck[i].code.toLowerCase() != this.state.retrivedcode.toLowerCase()) {
